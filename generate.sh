...
GENERATED="${GOPATH}/src/gitlab.com/tokend/course-certificates/sbt-bot/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/tokend/course-certificates/sbt-bot/docs/web_deploy"

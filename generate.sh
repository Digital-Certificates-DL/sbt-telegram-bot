...
GENERATED="${GOPATH}/src/gitlab.com/tokend/course-certificates/sbt-svc/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/tokend/course-certificates/sbt-svc/docs/web_deploy"

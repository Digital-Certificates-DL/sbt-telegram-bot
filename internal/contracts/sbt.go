...
func (_Factory *FactoryTransactor) Burn(opts *bind.TransactOpts, tokenId *big.Int) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "burn", tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) returns()
func (_Factory *FactorySession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Factory.Contract.Burn(&_Factory.TransactOpts, tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) returns()
func (_Factory *FactoryTransactorSession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Factory.Contract.Burn(&_Factory.TransactOpts, tokenId)
}
...
func (_Factory *FactoryTransactor) DeleteAdmin(opts *bind.TransactOpts, admin common.Address) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "deleteAdmin", admin)
}

// DeleteAdmin is a paid mutator transaction binding the contract method 0x27e1f7df.
//
// Solidity: function deleteAdmin(address admin) returns()
func (_Factory *FactorySession) DeleteAdmin(admin common.Address) (*types.Transaction, error) {
	return _Factory.Contract.DeleteAdmin(&_Factory.TransactOpts, admin)
}

// DeleteAdmin is a paid mutator transaction binding the contract method 0x27e1f7df.
//
// Solidity: function deleteAdmin(address admin) returns()
func (_Factory *FactoryTransactorSession) DeleteAdmin(admin common.Address) (*types.Transaction, error) {
	return _Factory.Contract.DeleteAdmin(&_Factory.TransactOpts, admin)
}

// SafeMint is a paid mutator transaction binding the contract method 0xd204c45e.
//
// Solidity: function safeMint(address to, string uri) returns(uint256)
func (_Factory *FactoryTransactor) SafeMint(opts *bind.TransactOpts, to common.Address, uri string) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "safeMint", to, uri)
}

// SafeMint is a paid mutator transaction binding the contract method 0xd204c45e.
//
// Solidity: function safeMint(address to, string uri) returns(uint256)
func (_Factory *FactorySession) SafeMint(to common.Address, uri string) (*types.Transaction, error) {
	return _Factory.Contract.SafeMint(&_Factory.TransactOpts, to, uri)
}

// SafeMint is a paid mutator transaction binding the contract method 0xd204c45e.
//
// Solidity: function safeMint(address to, string uri) returns(uint256)
func (_Factory *FactoryTransactorSession) SafeMint(to common.Address, uri string) (*types.Transaction, error) {
	return _Factory.Contract.SafeMint(&_Factory.TransactOpts, to, uri)
}
...
func (_Factory *FactoryTransactor) SafeTransferFrom0(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "safeTransferFrom0", from, to, tokenId, data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes data) returns()
func (_Factory *FactorySession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Factory.Contract.SafeTransferFrom0(&_Factory.TransactOpts, from, to, tokenId, data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes data) returns()
func (_Factory *FactoryTransactorSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _Factory.Contract.SafeTransferFrom0(&_Factory.TransactOpts, from, to, tokenId, data)
}
...
func (_Factory *FactoryTransactor) SetNewAdmin(opts *bind.TransactOpts, admin common.Address) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "setNewAdmin", admin)
}

// SetNewAdmin is a paid mutator transaction binding the contract method 0x8eec99c8.
//
// Solidity: function setNewAdmin(address admin) returns()
func (_Factory *FactorySession) SetNewAdmin(admin common.Address) (*types.Transaction, error) {
	return _Factory.Contract.SetNewAdmin(&_Factory.TransactOpts, admin)
}

// SetNewAdmin is a paid mutator transaction binding the contract method 0x8eec99c8.
//
// Solidity: function setNewAdmin(address admin) returns()
func (_Factory *FactoryTransactorSession) SetNewAdmin(admin common.Address) (*types.Transaction, error) {
	return _Factory.Contract.SetNewAdmin(&_Factory.TransactOpts, admin)
}
...
func (_Factory *FactoryTransactor) TransferToken(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Factory.contract.Transact(opts, "transferToken", from, to, tokenId)
}

// TransferToken is a paid mutator transaction binding the contract method 0xf5537ede.
//
// Solidity: function transferToken(address from, address to, uint256 tokenId) returns()
func (_Factory *FactorySession) TransferToken(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Factory.Contract.TransferToken(&_Factory.TransactOpts, from, to, tokenId)
}

// TransferToken is a paid mutator transaction binding the contract method 0xf5537ede.
//
// Solidity: function transferToken(address from, address to, uint256 tokenId) returns()
func (_Factory *FactoryTransactorSession) TransferToken(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Factory.Contract.TransferToken(&_Factory.TransactOpts, from, to, tokenId)
}
